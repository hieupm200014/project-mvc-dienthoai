...
namespace Proj_day11_test.Controllers
{
    public class tblCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Categoryid,CategoryName,MetaTitle")] tblCategory tblCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Categoryid,CategoryName,MetaTitle")] tblCategory tblCategory)
        {
            if (ModelState.IsValid)
            {
